...
var endDate = Date.parse(new Date(2020,0,0,0,0,0,0));



var myCountdown = setInterval(myTimer,1000)


function myTimer(){

    var now = new Date();
    var countdown =  endDate - now.getTime();
...
//time = day * hour * minutes * seconds * miliseconds
//96 * 24h * 60m * 60s * 1000ms